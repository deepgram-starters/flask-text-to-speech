...
Flask demo app for Deepgram Text-to-Speech.
...
```
feat(flask-text-to-speech): add diarization support
fix(flask-text-to-speech): resolve WebSocket close handling
refactor(flask-text-to-speech): simplify session endpoint
